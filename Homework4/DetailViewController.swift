...
final class DetailViewController: UIViewController {
    ...
    let statusChanger = UIAlertController()
    let genderChanger = UIAlertController()
    ...
    private func setUpViews(){
        ...
        NSLayoutConstraint.activate([
            ...
            nameHint.heightAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.1),
            ...
            statusHint.heightAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.1),
            ...
            speciesHint.heightAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.1),
            ...
            locationHint.heightAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.1),
            ...
            genderHint.heightAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.1),
            ...
            nameLabel.heightAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.1),
            ...
            statusLabel.heightAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.1),
            ...
            speciesLabel.heightAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.1),
            ...
            locationLabel.heightAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.1),
            ...
            genderLabel.heightAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.1),
    ...
    private func setUpData(_ data: Character) {
        ...
        statusLabel.text = data.statusString
        speciesLabel.text = data.species
        genderLabel.text = data.genderString
